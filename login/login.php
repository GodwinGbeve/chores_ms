                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <?php endif; ?>
                                    <form class="user" action="../actions/login_user.php" method="POST" name="loginForm"
                                        id="loginForm">
                                        <div class="form-group">
                                            <input type="email" class="form-control form-control-user" id="login-email"
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user" id="Pass-word"
                                        ...
                                        <button type="submit" class="btn btn-primary btn-user btn-block"
                                            id="loginButton" name="loginBtn">Login</button>
